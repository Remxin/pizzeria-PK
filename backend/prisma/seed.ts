...
async function main() {
  ...
  const products = [
    ...
    },
    {
      categoryId: pizzaCategory.id,
      name: 'Diavola',
      description: 'Pikantna pizza z pepperoni, chili i mozzarellą',
      basePrice: 36.0,
      imageUrl: '/images/products/diavola.png',
      isAvailable: true,
    },
    {
      categoryId: pizzaCategory.id,
      name: 'Quattro Formaggi',
      description: 'Pizza z czterema serami: mozzarella, gorgonzola, parmezan i pecorino',
      basePrice: 38.0,
      imageUrl: '/images/products/quattro-formaggi.png',
      isAvailable: true,
    },
    {
